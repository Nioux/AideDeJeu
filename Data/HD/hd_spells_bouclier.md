...
Attributes:
  ...
  Markdown: >+
    ...
    - **Temps d'incantation :** <!--CastingTime-->1 réaction à effectuer lorsque vous êtes touché par une attaque ou un sort de _[projectile magique](hd_spells_projectile_magique.md)_<!--/CastingTime-->
