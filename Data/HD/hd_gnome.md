...
Attributes:
  ...
  Markdown: >+
    ...
    **Augmentation de caractéristiques.** <!--AbilityScoreIncrease-->Votre valeur d'[Intelligence](hd_abilities_intelligence.md) augmente de 2.<!--/AbilityScoreIncrease-->
    ...
    **<!--GnomeCunningKey-->Ruse gnome<!--/GnomeCunningKey-->.** <!--GnomeCunningValue-->Vous bénéficiez d'un avantage pour tous les [jets de sauvegarde](hd_abilities_jets_de_sauvegarde.md) d'[Intelligence](hd_abilities_intelligence.md), [Sagesse](hd_abilities_wisdom.md) et [Charisme](hd_abilities_charisma.md) contre la magie.<!--/GnomeCunningValue-->
...
**Augmentation de caractéristiques.** Votre valeur d'[Intelligence](hd_abilities_intelligence.md) augmente de 2.
...
**Ruse gnome.** Vous bénéficiez d'un avantage pour tous les [jets de sauvegarde](hd_abilities_jets_de_sauvegarde.md) d'[Intelligence](hd_abilities_intelligence.md), [Sagesse](hd_abilities_wisdom.md) et [Charisme](hd_abilities_charisma.md) contre la magie.
...
## [Gnome des roches](hd_gnome_gnome_des_roches.md)

##### _[Rock Gnome](hd_gnome_gnome_des_roches.md)_



## [Gnome des fées](hd_gnome_gnome_des_fees.md)



## [Gnome des lacs](hd_gnome_gnome_des_lacs.md)
