...
Attributes:
  ...
  Markdown: >+
    ...
    - **Compétences** <!--Skills-->[Athlétisme](hd_abilities_strength_athletisme.md) +5, [Perception](hd_abilities_wisdom_perception.md) +2<!--/Skills-->

    - **Résistance aux dégâts** <!--DamageResistances-->de feu<!--/DamageResistances-->

    - **Sens** <!--Senses-->vision aveugle 3 m, vision dans le noir 18 m, [Perception passive](hd_abilities_dexterity_perception_passive.md) 12<!--/Senses-->
