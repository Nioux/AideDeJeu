...
Attributes:
  ...
  Markdown: >+
    ...
    **Augmentation de caractéristiques.** <!--AbilityScoreIncrease-->Votre valeur de [Force](hd_abilities_strength.md) augmente de 2 et votre valeur de [Charisme](hd_abilities_charisma.md) de 1.<!--/AbilityScoreIncrease-->
