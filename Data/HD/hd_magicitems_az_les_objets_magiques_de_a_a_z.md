...
- !MagicItem
  ...
  AttributesDictionary: >+
    ...
    Markdown: >+
      ...
      **_Six boutons._** Vous pouvez appuyer sur l'un des six boutons du sceptre par une action bonus. L'effet d'un bouton dure jusqu'au moment où vous appuyez sur un bouton différent ou sur le même bouton à nouveau, auquel cas le sceptre retrouve sa forme normale.
...
|---|---|---|
|1-6|Bénédiction|Bénédiction|
|7-12|Guérison|Soin des blessures (niveau 2) ou restauration inférieure|
|13-16|Faveur|Restauration supérieure|
|17-18|Châtiment|Frappe lumineuse|
|19|Convocations|Allié planaire|
|20|Vent|Marche sur le vent|
...
|d100|Type de cor|Fous de guerre invoqués|Conditions requises|
|---|---|---|---|
|01-40|Argent|2d4+2|Aucune|
|41-75|Cuivre|3d4+3|Maîtrise de toutes les armes courantes|
|76-90|Bronze|4d4+4|Maîtrise de toutes les armures intermédiaires|
|91-100|Fer|5d4+5|Maîtrise de toutes les armes de guerre|
...
|16-22|Porte en fer (d'une largeur et d'une hauteur maximales de 3 mètres, barrée du côté de votre choix) que vous pouvez placer dans une ouverture à votre portée ; la taille s'adapte aux dimensions de l'ouverture et s'y fixe d'ellemême.|
