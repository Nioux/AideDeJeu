...
Attributes:
  ...
  Markdown: >+
    ...
    **Augmentation de caractéristiques.** <!--AbilityScoreIncrease-->Votre valeur de [Dextérité](hd_abilities_dexterity.md) augmente de 1.<!--/AbilityScoreIncrease-->


    **<!--KeenSensesKey-->Sens aiguisés<!--/KeenSensesKey-->.** <!--KeenSensesValue-->Vos sens supérieurs vous permettent de suivre n'importe quelle piste. Vous bénéficiez d'un avantage à tous vos tests de [Sagesse (Survie)](hd_abilities_wisdom_survie.md) effectués afin de pister une créature.<!--/KeenSensesValue-->
