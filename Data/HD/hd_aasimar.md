...
Source: (MDR p59)
Attributes:
  ParentNameLink: '[Races](hd_races.md)'
  Markdown: >+
    >  <!--ParentNameLink-->[Races](hd_races.md)<!--/ParentNameLink-->
    ...
    **Augmentation de caractéristiques.** <!--AbilityScoreIncrease-->Votre valeur de [Charisme](hd_abilities_charisma.md) augmente de 2 et votre valeur de [Sagesse](hd_abilities_wisdom.md) de 1.<!--/AbilityScoreIncrease-->
